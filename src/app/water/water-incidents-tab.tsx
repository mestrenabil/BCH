...
export default function WaterIncidentsTab({ incidents, loading, onRefresh, showCreate, setShowCreate, buildParams }: { incidents: WaterIncident[]; loading: boolean; onRefresh: () => void; showCreate: boolean; setShowCreate: (value: boolean) => void; buildParams: () => URLSearchParams }) {
